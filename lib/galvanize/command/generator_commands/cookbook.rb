...
require 'galvanize/command/generator_commands/base'
    ...
    module ChefDK::GeneratorCommands
      ...
      class Cookbook < Base
        ...
        def setup_context
          ...
          ChefDK::Generator.add_attr_to_context(:include_chef_repo_source, false)
          ChefDK::Generator.add_attr_to_context(:policy_name, policy_name)
          ChefDK::Generator.add_attr_to_context(:policy_run_list, policy_run_list)
          ChefDK::Generator.add_attr_to_context(:policy_local_cookbook, '.')

          ChefDK::Generator.add_attr_to_context(:enable_delivery, enable_delivery?)
          ChefDK::Generator.add_attr_to_context(:delivery_project_dir, cookbook_full_path)
          ChefDK::Generator.add_attr_to_context(:build_cookbook_parent_is_cookbook, true)
          ChefDK::Generator.add_attr_to_context(:delivery_project_git_initialized, have_git? && !cookbook_path_in_git_repo?)

          ChefDK::Generator.add_attr_to_context(:verbose, verbose?)

          ChefDK::Generator.add_attr_to_context(:use_berkshelf, berks_mode?)
          ChefDK::Generator.add_attr_to_context(:pipeline, pipeline)
          ChefDK::Generator.add_attr_to_context(:kitchen, kitchen)
        end
        ...
        def read_and_validate_params
          ...
          @berks_mode = false if config[:policy]
